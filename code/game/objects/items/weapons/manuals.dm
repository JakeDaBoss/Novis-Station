...
/obj/item/weapon/book/manual/medical_cloning
	...
	dat = {"<html>
				...
				For this reason, you need to prepare a clean, defect-free Structural Enzyme (SE) injection for when they're done. If you're a competent Doctor, you will already have one ready on your working computer.
...
/obj/item/weapon/book/manual/security_space_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]corporate-regulations/" frameborder="0" id="main_frame"></iframe>
		</body>
